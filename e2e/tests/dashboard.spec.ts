...
test("scanning a real card photo drives the search via the OCR pipeline", async ({ page }) => {
  ...
  // O scan aplica a busca direto com o melhor palpite (código ou nome, ver
  // memory/ocr_code_recognition_limitation.md) — sem seletor de candidatos,
  // a lista de resultados normal do Dashboard já mostra a carta certa.
